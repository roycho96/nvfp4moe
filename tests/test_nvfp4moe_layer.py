...
def check_rht():
    ...
    import nvfp4moe.reference as nref
    from nvfp4moe.kernels.quantize import nvfp4_quantize_colwise, nvfp4_rht_amax, rht_matrix
    from nvfp4moe.recipe import TensorScale
...
def main():
    ...
    # Weighted combine used by the native FC2 path.
    ...
    check(
        "native buffers support decreasing routed batch size",
        y_s.shape == (T_small, d)
