"""NVFP4 scale state and expert-weight packing."""
...
_INV6 = float(torch.tensor(1.0, dtype=torch.float32) / torch.tensor(6.0, dtype=torch.float32))
...
__all__ = ["TensorScale", "quantize_expert_stack"]
