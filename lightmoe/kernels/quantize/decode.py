...
from ..gated import gated_postact_value, quantize_postact_fragment, validate_gated_activation
from .kernel import (
    _ABSP,
    _HI16,
    E4M3_EPS,
...
def nvfp4_decode_prepare(
    ...
    *,
    ...
    """Build batch-size-one expert assignments and quantize in one launch."""
